...
3. Review linked pull requests, issues, Linear work, related repositories in `meta-agents-demo`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
...
Prefer additive history: avoid git rebase in favor of git merge when reconciling concurrent commits.
