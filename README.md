# meta-agents-demo organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`meta-agents-demo`](https://github.com/meta-agents-demo).

## Canonical organization links

- GitHub organization: https://github.com/meta-agents-demo
- Public organization defaults: https://github.com/meta-agents-demo/.github
